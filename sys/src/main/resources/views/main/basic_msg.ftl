...
<div class="x-body">
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;overflow: auto;">
            ...
            <div class="layui-form-item">
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
                    <legend style="font-size:16px;">拥有角色(此处无法修改)</legend>
                </fieldset>
                <div class="layui-input-inline">
                  <#list boxJson as json>
                      <#if json.check?string=='true'><button disabled class="layui-btn layui-btn-normal">${json.name}</button></#if>
                  </#list>
                </div>
            </div>
...
<script>
    ...
    layui.use(['form','layer','upload'], function(){
        ...
        form.on('submit(update)', function(data){
            layerAjax('/user/updateUserNoRole', data.field, 'userList');
            return false;
        });
        form.render();
    });
