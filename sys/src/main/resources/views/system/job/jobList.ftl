  ...
  layui.use('table', function () {
    ...
    var $ = layui.$, active = {
      ...
      update: function () {
        ...
        if(data[0].status){
          layer.msg('已经启动任务无法更新,请停止后更新',{icon:5,offset: 'auto',area:['200px','100px'],anim:2});
          return false;
        }
    ...
    table.on('tool(job)', function (obj) {
      ...
      if (obj.event === 'detail') {
        ...
        if(!data.status) {
          ...
          layer.msg('已经启动任务无法更新,请停止后删除',{icon:5,offset: 'auto',area:['200px','100px'],anim:2});
        }
    ...
    $.ajax({
      ...
      success: function (d) {
        if(d.flag){
          layer.msg(d.msg,{icon:6,offset: 'auto',area:['250px','120px'],anim:2});
          layui.table.reload(tableId);
        }else{
          layer.msg(d.msg,{icon:5,offset: 'auto',area:['250px','120px'],anim:2});
        }
      }
    });
  }
