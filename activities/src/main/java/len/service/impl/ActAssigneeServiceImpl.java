...
import len.mapper.ActAssigneeMapper;
 ...
 */
@Service
public class ActAssigneeServiceImpl extends BaseServiceImpl<len.entity.ActAssignee, String> implements
        ActAssigneeService {
    ...
    @Override
    public BaseMapper<len.entity.ActAssignee, String> getMappser() {
