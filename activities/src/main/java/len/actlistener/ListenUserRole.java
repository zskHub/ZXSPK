...
public class ListenUserRole {
     ...
     * @param joinPoint
     */
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.UserController.updateUser(*,String[]))")
     ...
     * @param joinPoint
     */
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.UserController.addUser(*,String[]))")
    ...
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.UserController.del(..))")
    ...
    /**********************角色处理begin***************************/
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.RoleController.addRole(*,String[]))")
    ...
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.RoleController.updateUser(*,String[]))")
    ...
    @Around("execution(cn.zsk.core.util.JsonUtil cn.zsk.sys.controller.RoleController.del(..))")
