...
import cn.zsk.core.util.CommonUtil;
...
import len.entity.LeaveOpinion;
import len.entity.UserLeave;
import len.service.UserLeaveService;
import len.util.AnimatedGifEncoder;
import len.util.Base64Utils;
...
public class UserLeaveController extends BaseController {
    ...
    public String updateLeave(Model model, @PathVariable String taskId) {
        ...
        len.entity.BaseTask baseTask = (len.entity.BaseTask) variables.get("baseTask");
...
//            UserLeave userLeave = (UserLeave) variables.get("userLeave");
    ...
    @ResponseBody
    public String showTaskList(Model model, len.entity.Task task, String page, String limit) {
        CurrentUser user = CommonUtil.getUser();
        ...
        List<len.entity.Task> tasks = new ArrayList<>();
        Map<String, Object> map = new HashMap<>();
        len.entity.Task taskEntity = null;
        ...
        for (Task task1 : taskList) {
            ...
            len.entity.BaseTask userLeave = (len.entity.BaseTask) map.get("baseTask");

            taskEntity = new len.entity.Task(task1);
...
//        UserLeave userLeave = leaveService.selectByPrimaryKey(baseTask.getId());
    ...
    @ResponseBody
    public JsonUtil complete(len.entity.LeaveOpinion op, HttpServletRequest request) {
        ...
        //审批信息叠加
        List<len.entity.LeaveOpinion> leaveList = new ArrayList<>();
        Object o = variables.get(leaveOpinionList);
        if (o != null) {
            leaveList = (List<len.entity.LeaveOpinion>) o;
        }
        leaveList.add(op);
